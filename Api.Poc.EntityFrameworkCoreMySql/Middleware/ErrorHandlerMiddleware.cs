...
namespace Api.Poc.EntityFrameworkCoreMySql.Middleware
{
    public class ErrorHandlerMiddleware
    {
        ...
        public async Task Invoke(HttpContext context, IServicoLog log)
        {
            try
            {
                await _next(context);
        ...
        internal async Task HandleExceptionAsync(HttpContext context, Exception exception, IServicoLog log)
        {
