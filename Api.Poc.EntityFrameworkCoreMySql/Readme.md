...
WORKDIR /src
COPY ["Api.Poc.EntityFrameworkCoreMySql.csproj", "Api.Poc.EntityFrameworkCoreMySql/"]
RUN dotnet restore "Api.Poc.EntityFrameworkCoreMySql/Api.Poc.EntityFrameworkCoreMySql.csproj"

WORKDIR "/src/Api.Poc.EntityFrameworkCoreMySql"
COPY . .
RUN dotnet build "Api.Poc.EntityFrameworkCoreMySql.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "Api.Poc.EntityFrameworkCoreMySql.csproj" \
...
Execute unit tests
```
    cd "Api.Poc.EntityFrameworkCoreMySql/test/Api.Poc.EntityFrameworkCoreMySql.Tests"
    dotnet test
```

Deploy application
```
    cd "Api.Poc.EntityFrameworkCoreMySql/src/Api.Poc.EntityFrameworkCoreMySql"
